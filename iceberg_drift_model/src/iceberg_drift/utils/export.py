...
def export_to_netcdf(
    ...
    # Coordinates
    ds.coords['trajectory'] = np.arange(n_samples)
    ds.coords['step'] = np.arange(n_steps)
    ds.coords['time'] = ('trajectory', 'step'), _extract_timestamps(metadata, n_steps)

    # Dimensions
    ds.dims['trajectory'] = n_samples
    ds.dims['step'] = n_steps
    ...
    ds.attrs['history'] = f'Created {datetime.utcnow().isoformat()}Z'
